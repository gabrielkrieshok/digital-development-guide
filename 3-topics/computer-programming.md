...
- [Lenovo Game State | Lenovo Code & Play | Codeplay](https://lenovogamestate.com/codeplay/)
- [Code Your Future](https://codeyourfuture.co/) -- non-profit organisation supporting refugees with the dream of becoming developers.
- [Code Angel – Making coding fun again](http://mycodeangel.com/) -- Code games on a Raspberry Pi box.
...
- [Web - Google Developers](https://developers.google.com/web/billions/)
